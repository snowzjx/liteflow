...
#define INPUT_METRICS_POS_DST_IP_A 4
#define INPUT_METRICS_POS_DST_IP_B 5
#define INPUT_METRICS_POS_DST_IP_C 6
#define INPUT_METRICS_POS_DST_IP_D 7
#define INPUT_METRICS_POS_SRC_PORT 8
#define INPUT_METRICS_POS_DST_PORT 9
// More can be added
#define NUM_OF_INPUT_VALUE 10

#define OUTPUT_SHOULD_DROP 0
